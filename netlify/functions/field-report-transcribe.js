...
async function transcribe(openaiKey, audio, model) {
  ...
  body.append("prompt", `A Persian, English or Spanish daily construction field report containing project names, addresses, trade work, materials, safety notes, delays, and next steps. ${CONSTRUCTION_GLOSSARY}`);
